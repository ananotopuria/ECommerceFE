...
function Categories() {
  return (
    <>
      <div className="">
        <nav className="flex flex-col sm:text-xl xl:text-2xl 2xl:text-3xl gap-6 pr-[6rem] border-r-[0.1rem] max-sm:pr-[1rem]">
          <NavLink
            className="flex items-center pr-2 justify-between transition-all hover:text-action hover:underline mt-[4rem]"
            to="/"
          >
